...
TUNABLE_PARAMS: dict[str, tuple[ParamValueType, str]] = {
    ...
    "player_discovery_finder_share_pct": (
        ParamValueType.FLOAT,
        "Share of a player-discovered gate awarded to its finder",
    ),
    ...
    "guild_starting_capital_pct": (
        ParamValueType.FLOAT,
        "Share of guild creation cost retained as starting capital",
    ),
    ...
    "guild_operating_grace_ticks": (
        ParamValueType.INT,
        "Ticks before maintenance and automatic dividends begin",
    ),
...
PARAM_BOUNDS: dict[str, tuple[float | None, float | None]] = {
    ...
    "player_discovery_finder_share_pct": (0.0, 1.0),
    ...
    "guild_starting_capital_pct": (0.0, 1.0),
    "guild_total_shares": (1, None),
    "guild_max_float_pct": (0.0, 1.0),
    "guild_operating_grace_ticks": (0, None),
